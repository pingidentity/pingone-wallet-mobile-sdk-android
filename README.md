...
will find the `PingOneWallet-2.0.3.aar` dependency required for the PingOne Wallet Android SDK in
...
Note `../dependencies/` should point to where you are storing the `PingOneWallet-2.0.3.aar`
